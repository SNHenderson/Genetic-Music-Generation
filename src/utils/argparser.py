...
def parse():
    ...
    parser.add_argument("-n", "--number", type=int, help="The number n for saving each nth generation")
    parser.add_argument("-t", "--title", type=int, help="The title of the file to save")
